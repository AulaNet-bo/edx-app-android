    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (position == 0) {
            ...
            iconDrawable = new IconDrawable(context, FontAwesomeIcons.fa_flag)
                    .sizeRes(context, R.dimen.edx_small)
                    .colorRes(context, discussionComment.isAbuseFlagged() ? R.color.primaryBaseColor : R.color.primaryBaseColor);
            ...
            if (TextUtils.equals(loginPrefs.getUsername(), discussionComment.getAuthor())) {
                ...
                holder.discussionCommentCountReportTextView.setTextColor(context.getResources().getColor(R.color.primaryBaseColor));
